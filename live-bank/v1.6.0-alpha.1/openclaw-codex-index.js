...
function extractInboundMedia(event) {
	...
	// FORGE_CODEX_IMAGE_STABILITY_V1_1: dedupe legacy singular/plural media aliases.
	const media = [];
...
async function runBoundTurn(params) {
	...
	try {
		...
		collector.setTurnId(turnId);
                ...
                // FORGE_NO_REPLY_DIRECT_ROLLBACK_V3
                if (completed.replyText.trim() === "NO_REPLY") {
